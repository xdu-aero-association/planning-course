...
void gridPathFinder::initGridMap(double _resolution, Vector3d global_xyz_l,
...
void gridPathFinder::setObs(const double coord_x, const double coord_y,
...
Eigen::Vector3d
gridPathFinder::coordRounding(const Eigen::Vector3d &coord) const {
